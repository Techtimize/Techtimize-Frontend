        ...
        <div className="mx-[auto] max-w-[90%] sm:flex flex-wrap sm:container md:max-w-[80%] lg:max-w-[82%]">
            {
                data.map((index)=>{
                    return(
                        <Link href={`../blog-details/${index._id}`} key={index._id} className="w-[100%] mb-[30px] rounded-[24px] p-[25px] sm:w-[48%] lg:w-[32%] mr-[1%] shadow-[rgba(17,17,26,0.1)_0px_4px_16px,_rgba(17,17,26,0.05)_0px_8px_32px]">
