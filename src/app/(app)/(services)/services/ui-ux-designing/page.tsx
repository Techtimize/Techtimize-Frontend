...
const structuredData = {
  ...
  "description": "Techtimize offers expert UI/UX design services focused on creating intuitive, engaging, and visually appealing digital experiences. We design user interfaces that drive engagement, enhance usability, and strengthen brand identity across web and mobile platforms.",
  "provider": {
    "@type": "Organization",
    "name": "Techtimize",
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const baseMetadata = await generateMetadataFromBE("uiuxDesign");
    ...
    <>
      ...
      <div className="custom-container sm:flex items-center">
        <div className="sm:w-[50%]">
          <Heading_proto 
            heading="Overview" 
            alignment="left" 
            para="At Techtimize, we craft digital experiences that are not only visually stunning but also intuitive and user-friendly. Our UI/UX design services focus on understanding user behavior, streamlining interactions, and creating designs that keep users engaged. From wireframes to final interfaces, we ensure every touchpoint reflects your brand while delivering a seamless journey across devices." 
          />
        </div>
        <div className="sm:w-[50%]">
          <Image 
      ...
      <div className="max-w-[90%] sm:max-w-[60%] mx-[auto]">
        <Heading_proto 
          ...
          para="At Techtimize, we follow a structured design process to ensure creativity and functionality go hand in hand:" 
        />
      </div>
      ...
      <div className='flex flex-wrap justify-between relative text-white p-[15px] sm:p-[40px] lg:p-[110px] lg:pt-[90px] bg-[#0B4D8E] rounded-[10px] max-w-[90%] mx-[auto] bg-no-repeat items-center'>
        ...
        <div className="w-[100%] sm:w-[70%] lg:w-[55%]">
          ...
          <p>
            Do you have a business and want to impress your clients with your website and digital platform? Then we're ready to help!
          </p>
        </div>
