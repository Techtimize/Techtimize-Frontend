...
const structuredData = {
  ...
  "description": "Techtimize provides cutting-edge Artificial Intelligence services to help businesses automate processes, gain actionable insights, and make smarter decisions. Our AI solutions leverage machine learning, natural language processing, and predictive analytics to optimize performance and growth.",
  "provider": {
    "@type": "Organization",
    "name": "Techtimize",
