...
export default async function JobDescriptionPage({ id: jobId }: { id: string }) {
  ...
  return (
    <div className="relative p-6 md:p-8 lg:p-10 max-w-4xl mx-auto">
      {" "}
      ...
      <ul className="list-disc pl-6 sm:pl-4 text-gray-700 mb-6">
        {Array.isArray(job.positionRequirement) ? (
          job.positionRequirement.map((item, index) => (
      ...
      {/* Additional Info */}
      <p className="text-gray-700 mb-6">
        If you are passionate and ready to take on exciting challenges, we would
        love to hear from you. Join our team at Techtimize and be part of a
        culture that values innovation and creativity. Apply now to help us
        shape the future of technology! To apply, please send your resume and a
        cover letter to <b>hr@techtimize.co</b>.
      </p>
