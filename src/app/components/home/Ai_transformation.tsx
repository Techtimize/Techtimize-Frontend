...
export default function Transforming() {
  return (
     ...
     <div className="transforming !max-w-[98%] mx-[auto]  sm:container  sm:flex justify-between rounded-[50px] sm:px-[0] px-[15px]" >
      ...
      <Image loading="lazy" className="w-[100%] max-w-[92%] mx-[auto] h-[100%] mt-[28px] sm:my-[0] rounded-[16px] x1750:object-cover x1750:h-[550px] shadow-[rgba(100,100,111,0.2)_0px_7px_29px_0px] object-cover" src={"/assets/images/ai-transformation.svg"}  alt="ABout Us image" height={500}  width={500}/>
      </div>
      </div>
</div>
     </div>
