    ...
    <div className={clsx("relative", className)}>
      ...
      <div className="relative sm:pb-[50px]">
        ...
        <button
          ...
          className="absolute z-[5] bottom-[0%] left-[32%] sm:left-[40%] lg:left-[46%] top-auto bg-white rounded-full p-2"
        >
        ...
        <button
          ...
          className="absolute z-[5] bottom-[0%] right-[32%] sm:right-[40%] lg:right-[46%] top-auto bg-white rounded-full p-2"
        >
